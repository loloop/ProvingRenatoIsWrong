...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
        ...
        protected Transform m_Cam;                  // A reference to the main camera in the scenes transform
        protected Vector3 m_CamForward;             // The current forward direction of the camera
